...
from util.datasets import get_dataset,ultrasound_nerve
...
class SearchNetwork(object):
    ...
    def _init_dataset(self):
        ...
        self.n_classes = trainset.NUM_CLASS #num_class
        self.in_channels = trainset.IN_CHANNELS #in_channels
...
#E:\NasUnet-master\NasUnet-master\experiment\util\transform.py
